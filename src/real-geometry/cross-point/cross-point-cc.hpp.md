...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"src/real-geometry/cross-point/cross-point-cc.hpp\"\n\n#line\
  ...
  timestamp: '2023-06-01 02:14:31+09:00'
  verificationStatus: LIBRARY_ALL_AC
  verifiedWith:
  - test/aoj/cgl/7_E.test.cpp
  - test/aoj/cgl/7_F.test.cpp
documentation_of: src/real-geometry/cross-point/cross-point-cc.hpp
layout: document
redirect_from:
- /library/src/real-geometry/cross-point/cross-point-cc.hpp
- /library/src/real-geometry/cross-point/cross-point-cc.hpp.html
