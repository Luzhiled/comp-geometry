...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"src/real-geometry/mapping/projection.hpp\"\n\n#line 2 \"\
  ...
  code: "#pragma once\n\n#include \"src/real-geometry/class/point.hpp\"\n#include\
    ...
    \n\n#include <complex>\n\nnamespace geometry {\n\n  template< typename R >\n \
    \ point<R> projection(const line<R> &l, const point<R> &p) {\n    R t = inner_product<R>(p\
    \ - l.a, l.a - l.b) / std::norm(l.a - l.b);\n    return l.a + (l.a - l.b) * t;\n\
    \  }\n\n}\n"
  dependsOn:
  - src/real-geometry/class/point.hpp
...
documentation_of: src/real-geometry/mapping/projection.hpp
layout: document
redirect_from:
- /library/src/real-geometry/mapping/projection.hpp
- /library/src/real-geometry/mapping/projection.hpp.html
