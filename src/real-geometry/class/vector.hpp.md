...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"src/real-geometry/class/vector.hpp\"\n\n#include <complex>\n\
    #include <iostream>\n\nnamespace geometry {\n\n  template< typename R >\n  class\
    \ vec2d : public std::complex< R > {\n    using complex = std::complex< R >;\n\
...
documentation_of: src/real-geometry/class/vector.hpp
layout: document
redirect_from:
- /library/src/real-geometry/class/vector.hpp
- /library/src/real-geometry/class/vector.hpp.html
