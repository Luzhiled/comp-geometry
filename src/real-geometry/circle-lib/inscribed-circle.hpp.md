...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"src/real-geometry/circle-lib/inscribed-circle.hpp\"\n\n\
    ...
    \ geometry {\n\n  template< typename R >\n  circle<R> inscribed_circle(const point<R>\
    \ &a, const point<R> &b, const point<R> &c) {\n    R A = std::abs(b - c), B =\
    \ std::abs(c - a), C = std::abs(a - b);\n\n    point<R> o((a * A + b * B + c *\
    \ C) / (A + B + C));\n    R r = distance_sp({a, b}, o);\n\n    return {o, r};\n\
    \  }\n\n}\n"
  code: "#pragma once\n\n#include \"src/real-geometry/class/circle.hpp\"\n#include\
    \ \"src/real-geometry/class/point.hpp\"\n#include \"src/real-geometry/distance/distance-sp.hpp\"\
    \n\n#include <complex>\n\nnamespace geometry {\n\n  template< typename R >\n \
    \ circle<R> inscribed_circle(const point<R> &a, const point<R> &b, const point<R>\
  ...
  requiredBy: []
  timestamp: '2023-06-01 01:49:12+09:00'
  verificationStatus: LIBRARY_ALL_AC
  verifiedWith:
  - test/aoj/cgl/7_B.test.cpp
documentation_of: src/real-geometry/circle-lib/inscribed-circle.hpp
layout: document
redirect_from:
- /library/src/real-geometry/circle-lib/inscribed-circle.hpp
- /library/src/real-geometry/circle-lib/inscribed-circle.hpp.html
