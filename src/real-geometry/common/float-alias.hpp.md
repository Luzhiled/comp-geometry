...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"src/real-geometry/common/float-alias.hpp\"\n\nnamespace\
...
documentation_of: src/real-geometry/common/float-alias.hpp
layout: document
redirect_from:
- /library/src/real-geometry/common/float-alias.hpp
- /library/src/real-geometry/common/float-alias.hpp.html
